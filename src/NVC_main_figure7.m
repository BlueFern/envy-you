...
figure(1), plot(vi,wi); xlabel('vi'), ylabel('wi'), title([cGMP_switch, Ca_switch]), legend('no cGMP', 'with cGMP'), hold all
% figure, plot(vi,Po); xlabel('vi'), ylabel('Kact'), title([cGMP_switch, Ca_switch])
figure(2), plot(cai,wi); xlabel('cai'), ylabel('wi'), title([cGMP_switch, Ca_switch]), legend('no cGMP', 'with cGMP'), hold all
