...
global cGMP_switch Ca_switch %(1: Ca variable, 0: Ca locked at 1uM)
Ca_switch = 1;

global cGMP_activated
...
figure(1), plot(vi,wi); xlabel('vi'), ylabel('wi'), title(cGMP_activated), hold all
% figure, plot(vi,Po); xlabel('vi'), ylabel('Kact'), title([cGMP_switch, Ca_switch])
figure(2), plot(cai,wi); xlabel('cai'), ylabel('wi'), title(cGMP_activated), hold all
% figure, plot(cai,Po); xlabel('cai'), ylabel('Kact'), title([cGMP_switch, Ca_switch])
figure(3), plot(vi,Ki); xlabel('vi'), ylabel('Ki'), title(cGMP_activated), hold all

% clear vi Po vca3 cai wi Ki
lalaa = 1;
